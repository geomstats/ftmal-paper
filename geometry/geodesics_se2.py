...
the same: it has constant angular velocity. The translation parts differ however.
"""
...
def main():
    ...
    ax.set_aspect('equal')
    plt.legend(loc='best')
    plt.savefig('../figures/se2-left-right.eps', bbox_inches='tight', pad_inches=0)
